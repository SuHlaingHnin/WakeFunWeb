window.__require = function e(t, n, r) {
  ...
  BookOverviewManager: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      showLevelContent: function showLevelContent(button) {
        this.levelContent.position.x == button.node.position.x ? this.levelContent.active = !this.levelContent.active : this.levelContent.active = true;
          ...
          return tslib.__generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              return [ 4, Promise.all(services.filter(function(service) {
        ...
        PersistentConnection.prototype.establishConnection_ = function() {
          if (this.shouldReconnect_()) {
            ...
            this.authTokenProvider_.getToken(forceRefresh).then(function(result) {
              ...
              if (!canceled_1) {
                util.CONSTANTS.NODE_ADMIN && warn(error);
                closeFn_1();
              }
            });
          }
  ...
  7: [ function(require, module, exports) {
    ...
    "./src/errors/InvalidMonthError": 8,
    "./src/errors/InvalidMonthsAbbrError": 9,
    "./src/errors/InvalidMonthsError": 10,
    "./src/errors/InvalidWeekdayError": 11,
    "./src/errors/InvalidWeekdaysAbbrError": 12,
    "./src/errors/InvalidWeekdaysError": 13
  } ],
  ...
  Calendar: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      start: function start() {
        ...
        this.initDateLabels();
        this.addListenermidDateChildren();
        this.spawnEmojis();
        var date = new Date();
      ...
      initNoteList: function initNoteList() {
        ...
        Note.createNoteList(this.getTodayDate(), _max, calendarDays);
      },
      ...
      saveDiaryMood: function saveDiaryMood(event) {
        ...
        _diary.mood = Diary.getMoodByIndex(moodIndex);
        Note.saveDiaryID(date, _diary.id);
      },
      saveDiaryType: function saveDiaryType(event) {
        ...
        var _diary = Diary.getDiaryByDate(date);
        null == _diary && (_diary = Diary.getNewDiary(date));
        _diary.type = Diary.getTypeByIndex(typeIndex);
      },
      saveDiaryWhoWhat: function saveDiaryWhoWhat(event) {
        ...
        var _diary = Diary.getDiaryByDate(date);
        null == _diary && (_diary = Diary.getNewDiary(date));
        _diary.whoWhat = Diary.getWhoWhatByIndex(whowhatIndex);
      },
      ...
      clearUI: function clearUI() {
        var counter = 0;
        for (var i = 0; i < this.lblDates.length; i++) {
          this.lblDates[counter].string = "";
          counter++;
        }
      },
      initDateLabels: function initDateLabels() {
        for (var i = 0; i < this.midDateChildren.length; i++) {
          this.lblDates[i] = this.midDateChildren[i].getChildByName("Background").getChildByName("Label").getComponent(cc.Label);
          this.lblDates[i].fontSize = 40;
          this.lblDates[i].string = "";
        }
      },
      addListenermidDateChildren: function addListenermidDateChildren() {
        for (var i = 0; i < this.midDateChildren.length; i++) {
          this.midDateChildren[i].name = this.lblDates[i].string;
          this.midDateChildren[i].on("showNote", this.showNotePanel, this);
          this.midDateChildren[i].addComponent("Day");
        }
      },
      ...
      showCalendarData: function showCalendarData() {
        ...
        this.lblMonthMid.string = this.monthNames[this.monthCounter - 1] + "(" + this.yearCounter + ")";
        var array = this.getTodayDate().split("/");
        var monthYear = array[1] + "/" + array[2];
        var resultNoteList = Note.getNoteListByKey(monthYear);
        var counter = 0;
        var calendarDays = calendar().of(this.yearCounter, this.monthCounter - 1).calendar;
        this.max = this.getMaxDay(this.monthCounter, this.yearCounter);
        for (var i = 0; i < calendarDays.length; i++) for (var j = 0; j < calendarDays[i].length; j++) {
          ...
          if (0 != value) {
            this.lblDates[counter].string = value;
            this.midDateChildren[counter].getComponent(cc.Button).interactable = true;
            this.checkEmojis(this.trainingDateChildren[counter]);
            this.checkEmojis(this.diaryDateChildren[counter]);
          }
          counter++;
        }
        this.addListenermidDateChildren();
      ...
      resetDateButtons: function resetDateButtons() {
        for (var i = 0; i < this.midDateChildren.length; i++) this.midDateChildren[i].getComponent(cc.Button).interactable = false;
        this.hideEmojis(this.trainingDateChildren);
        this.hideEmojis(this.diaryDateChildren);
      },
      ...
      showTrainingMode: function showTrainingMode() {},
  ...
  ChapterController: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      init: function init() {
        ...
        this.button.node.on("mouseup", function() {
  ...
  Day: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      start: function start() {
        ...
        this.label = this.node.getChildByName("Background").getChildByName("Label").getComponent(cc.Label);
        this.node.on("click", this.onClick, this);
      },
      onClick: function onClick(event) {
        cc.log("clicked => " + this.node.name);
        this.UIManager.zoomEffect(this.node);
        this.Calendar.currentDay = this.label.string;
  ...
  Diary: [ function(require, module, exports) {
    ...
    var Diary = function() {
      ...
      function init() {
        ...
        var whowhats = [ "friend", "family", "work" ];
        var diary = {
          id: "",
          type: "",
          mood: "",
  ...
  GLOBALS: [ function(require, module, exports) {
    ...
    window.BOTTOM_UI = {
      ...
      BTN_INFO: "Canvas/BottomUI/btnInfo"
    };
    ...
    window.BOOK_OVERVIEW = {
      ...
      BTN_EBOOK: "Canvas/BookOverview/Flower/btn_ebook",
    ...
    window.CALENDAR_PANEL = {
      ...
      MID_BACKGROUND: {
        ...
        BTN_RIGHT_MONTH: "Canvas/Calendar/mid_background/top_background/btn_right",
        BTN_LEFT_MONTH: "Canvas/Calendar/mid_background/top_background/btn_left",
        LBL_MONTH_MID: "Canvas/Calendar/mid_background/top_background/lbl_month",
        BTN_DAYS: "Canvas/Calendar/mid_background/button_container"
      },
      PLAN_MODE: {
        SELF: "Canvas/Calendar/planMode",
        BTN_RIGHT_MONTH: "Canvas/Calendar/planMode/top_background/btn_right",
        BTN_LEFT_MONTH: "Canvas/Calendar/planMode/top_background/btn_left",
        LBL_MONTH_MID: "Canvas/Calendar/planMode/top_background/lbl_month",
        BTN_DAYS: "Canvas/Calendar/planMode/button_container"
      },
      DIARY_MODE: {
        SELF: "Canvas/Calendar/diaryMode",
        BTN_RIGHT_MONTH: "Canvas/Calendar/diaryMode/top_background/btn_right",
        BTN_LEFT_MONTH: "Canvas/Calendar/diaryMode/top_background/btn_left",
        LBL_MONTH_MID: "Canvas/Calendar/diaryMode/top_background/lbl_month",
        BTN_DAYS: "Canvas/Calendar/diaryMode/button_container"
      },
      TRAINING_MODE: {
        SELF: "Canvas/Calendar/trainingMode",
        BTN_RIGHT_MONTH: "Canvas/Calendar/trainingMode/top_background/btn_right",
        BTN_LEFT_MONTH: "Canvas/Calendar/trainingMode/top_background/btn_left",
        LBL_MONTH_MID: "Canvas/Calendar/trainingMode/top_background/lbl_month",
    ...
    var Note = function() {
      ...
      function init() {
        ...
        return {
          ...
          createNoteList: function createNoteList(date, max, calendarDays) {
            var tempArray = [];
            var counter = 0;
            var dateArray = date.split("/");
            var monthYear = dateArray[1] + "/" + dateArray[2];
      ...
      function init() {
        ...
        return {
          ...
          addPlan: function addPlan(plan) {
            planList.push(plan);
            console.log("Add New Plan : " + planList.length);
            this.showPlanData(plan);
          },
  ...
  SpawnSurprise: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        self = this;
        var _node = self.node;
        cc.loader.loadRes("prefabs/Surprise", cc.Prefab, function(err, prefab) {
          var surprise = cc.instantiate(prefab);
          _node.addChild(surprise);
          surprise.setPosition(-50, 66);
        });
      }
    });
    cc._RF.pop();
  ...
  UIManager: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      init: function init() {
        ...
        this.btnInfo = cc.find(BOTTOM_UI.BTN_INFO).getComponent(cc.Button);
        ...
        this.pausePanelOverLay.on("touchstart", function() {
          ...
          false == _this.lblPause.active && _this.setTimer(self.time);
        });
        ...
        this.shardsPanel.node.on("click", function() {
          _this.showHideShardsPanel();
        }, this);
        ...
        this.btnDonePlan.node.on("click", function() {
          _this.zoomEffect(_this.btnDonePlan.node);
          _this.savePlanData();
        ...
        this.btnEbook.node.on("click", function() {
          _this.showBookInfo();
        }, this);
      ...
      showCalendarPlan: function showCalendarPlan() {
        this.notePanel.active = false;
        this.planMode.active = true;
      },
...
}, {}, [ "AchData", "AchievementManager", "Alarm", "BookInfoManager", "BookOverviewManager", "Calendar", "ChapterController", "Day", "Firebase", "FriendData", "FriendManager", "GLOBALS", "ItemController", "SpawnEmojis", "SpawnSurprise", "UIManager", "Achievement", "Chapter", "Diary", "Friend", "Note", "PersonInfo", "Plan", "PowerLevel" ]);